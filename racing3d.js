  ...
  window.KartGL = {
    create(canvas, opts) {
      ...
      function kartModel(body, helmet) {
        ...
        // [mesh, sx,sy,sz, px,py,pz, color]
        m = [
          [MESH.cube, 26, 7, 38, 0, 8, 0, B],                      // シャシー
          [MESH.cube, 16, 5, 12, 0, 11, 14, shadeRgb(B, 0.13)],    // ノーズ
          [MESH.cube, 14, 4, 14, 0, 11.5, -8, shadeRgb(B, -0.1)],  // シート部
          [MESH.cube, 24, 1.6, 9, 0, 19, -17, shadeRgb(B, -0.22)], // ウィング
          [MESH.cube, 2, 5, 2, -7, 14.5, -17, shadeRgb(B, -0.3)],
          [MESH.cube, 2, 5, 2, 7, 14.5, -17, shadeRgb(B, -0.3)],
          [MESH.sphere, 6.4, 6.4, 6.4, 0, 17.5, -2, Hm],           // ヘルメット
          [MESH.cube, 7.5, 3.2, 2, 0, 17, 3.6, [0.1, 0.13, 0.18]], // バイザー
          [MESH.wheel, 5, 6.2, 6.2, -14, 6.2, 12, [0.1, 0.1, 0.11]],
          [MESH.wheel, 5, 6.2, 6.2, 14, 6.2, 12, [0.1, 0.1, 0.11]],
          [MESH.wheel, 5, 7, 7, -14.5, 7, -12, [0.1, 0.1, 0.11]],
          [MESH.wheel, 5, 7, 7, 14.5, 7, -12, [0.1, 0.1, 0.11]],
        ];
        kartCache.set(key, m);
        return m;
