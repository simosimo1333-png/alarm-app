...
function buildCourse1() {
  ...
  CP_ZONES = [
    ...
    { cp: 8, x0: 50, x1: 60, z0: 48.6, z1: 51.5, yMin: -0.5 },   // ゴールの島
  ];
  GOAL = { x0: 49, x1: 61, z0: 51.9, y: -0.6 };
}
...
function buildCourse2() {
  ...
  CP_ZONES = [
    ...
    { cp: 7, x0: -2.5, x1: -0.7, z0: -16.5, z1: -9.5, yMin: 9.7 }, // ゴールのまえ
  ];
  GOAL = { x0: -8.2, x1: -1.4, z0: -16.8, y: 11.1 };
}
...
function buildCourse3() {
  ...
  GOAL = { x0: 52.7, x1: 59.3, z0: 27.7, y: 9.7 };
}
